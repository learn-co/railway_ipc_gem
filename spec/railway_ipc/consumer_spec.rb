RSpec.describe RailwayIpc::Consumer do
  ...
  it "registers the handler for the message" do
    ...
    expect(RailwayIpc::Consumer::HANDLERS["LearnIpc::Commands::TestMessage"]).to eq({
      :handler_class=>RailwayIpc::TestHandler,
      :message_class=>LearnIpc::Commands::TestMessage
    })
  end
