...
module RailwayIpc
  class Client
    ...
    def await_response(timeout)
      ...
      error = self.class.rpc_error_adapter_class.error_message(TimeoutError.new, request_message)
    ...
    def decode_for_error(e, payload)
      ...
      self.class.rpc_error_adapter_class.error_message(payload, request_message)
    end
  end
end
